...
// ---------------------------------------------------------------------------------------------------------------
     ...
     * editing tasks, toggling form visibility, and handling errors. It also handles rendering the sorted task list
     * and updates the remaining time for tasks.
     *
     * Depends on taskDataModule and validationTaskModule
     * @type {{editTask, toggleErrors, removeTask, renderEmptyList, toggleFormVisibility, updateRemainingTimes,
     *        toggleSortOptions, renderTaskList, toggleEditButtonsVisibility, removeEmptyList}}
     */
    const UiModule = (function() {
        ...
        /**
         * Toggles the visibility of form buttons and edit buttons in the user interface.
         *
         * @param {boolean} show - Determines which buttons to show:
         *   - true: Hides the "add task" buttons and shows the "edit" buttons.
         *   - false: Shows the "add task" buttons and hides the "edit" buttons.
         *
         * This function modifies the DOM by adding or removing the d-none class from
         * elements with the .addTaskButtons and .editButtons classes.
         */
        ...
        /**
         * Removes a task from the DOM based on its name and updates the filtered task list.
         * This function finds task items with a matching data-task-name attribute,
         * removes them from the DOM, and triggers an update to the filtered task view.
         *
        ...
        /**
         * Removes the "empty list" message if it exists in the DOM.
         */
...
// ---------------------------------------------------------------------------------------------------------------
     ...
     *
     * @type {{addTask, deleteTask, getTaskByName, getTasks, reverseTaskList}}
     */
    const taskDataModule = (function (){
        ...
        /**
         * Finds and returns a task from the task list by its name.
         *
...
// ---------------------------------------------------------------------------------------------------------------
     ...
     *
     * Depends on taskDataModule, UiModule, validationTaskModule, filterSortModule and formModule
     * @type {{cancel, submit, edit, create, delete, save}}
     */
    const manageTaskListModule = ( function () {
        ...
        /**
         * Adds a new task if the form data is valid.
         *
         * - Validates form data and adds the task.
         * - Updates the task list, UI, and remaining times.
        ...
        /**
         * Prepares a task for editing by showing the form and populating it with task data.
         *
         * @param {string} taskName - The name of the task to edit.
         * @returns {void}
         */
        ...
        /**
         * Saves changes to the currently edited task.
         * Deletes the original task, hides edit buttons, and re-adds the updated task.
         *
         * @returns {void}
         *
         */
        ...
        /**
         * Deletes a task from both the data and the UI.
         *
         * @param {string} taskName - The name of the task to delete.
         * @returns {void}
         */
...
// ---------------------------------------------------------------------------------------------------------------
     ...
     *
     * Depends on taskDataModule and UiModule
